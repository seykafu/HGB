...
export function Button({
  ...
  const baseClasses = 'px-4 py-2 rounded-xl font-medium tracking-tight focus:outline-none focus-visible:ring-2 focus-visible:ring-[#533F31]/40 transition relative'
